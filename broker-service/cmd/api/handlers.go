...
func (app *Config) logItem(w http.ResponseWriter, payload LogPayload) {
	...
	if response.StatusCode != http.StatusAccepted {
		app.errorJSON(w, errors.New("error processing the request"), response.StatusCode)
	}
...
func (app *Config) authenticate(w http.ResponseWriter, authPayload AuthPayload) {
	...
	if response.StatusCode == http.StatusUnauthorized {
		...
		app.errorJSON(w, errors.New("error calling the authentication service"))
		return
	}
...
// Another unused function, was replaced by the logItemViaRPC
